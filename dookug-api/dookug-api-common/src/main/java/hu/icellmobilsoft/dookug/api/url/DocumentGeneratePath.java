...
public class DocumentGeneratePath extends ServicePath {
    ...
    /**
     * {@value #INTERNAL_DOCUMENT_GENERATE_STORED_TEMPLATE}
     */
    public static final String INTERNAL_DOCUMENT_GENERATE_STORED_TEMPLATE = INTERNAL_DOCUMENT_GENERATE + STORED_TEMPLATE;
    /**
     * {@value #INTERNAL_DOCUMENT_STORED_TEMPLATE}
     */
    public static final String INTERNAL_DOCUMENT_STORED_TEMPLATE = INTERNAL_DOCUMENT + STORED_TEMPLATE;
    /**
