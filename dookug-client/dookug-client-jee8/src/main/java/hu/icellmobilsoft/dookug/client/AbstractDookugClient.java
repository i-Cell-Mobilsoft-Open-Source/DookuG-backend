...
public abstract class AbstractDookugClient extends AbstractBaseDookugClient {
     ...
     *             if any error occurs
     */
    protected GeneratedDocumentDto postDocumentGenerateEntityBody(DocumentGenerateWithTemplatesRequest request, Boolean compressed) throws BaseException {
        try {
    ...
    /**
     * Create rest request from parameters
     * 
     * @param templateStorageMethodType
     *            {@link TemplateStorageMethodType}
     * @param parameters
     *            Collection of {@link ParameterType}
     * @param parametersData
     *            {@link ParametersDataType}
     * @param templateName
     *            template name
     * @param templateLanguage
     *            template language
