...
The `setResponseContentGzipped(boolean)` method allows controlling whether the generated document should be returned in GZIP compressed format. By default, the response is not compressed.
